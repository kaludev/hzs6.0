            ...
            <div className={styles.aboutSec}>
                <div className={styles.aboutDesc}>
                    <div className={styles.aboutDescMain}>
                        ...
                        <Link href="/smerovi"><div className={`${styles.primaryButton} primaryButton`}>Prikaži događaje</div></Link>
                    </div>
                </div>
            ...
            <div className={styles.aboutSec}>
                <div className={styles.aboutDesc}>
                    <div className={styles.aboutDescMain}>
                        ...
                        <Link href="/smerovi"><div className={`${styles.primaryButton} primaryButton`}>Započni odmah</div></Link>
                    </div>
                </div>
